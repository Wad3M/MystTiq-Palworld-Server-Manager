# v0.4.6.7 Build/Test Plan

Run `Update-FromDownloads.ps1` or the complete current release gate. Promotion requires 0 validation errors/warnings, all v0.4.6.7 logic tests, Windows/Linux headless and Avalonia builds, runtime smoke, packaging, and GUI acceptance.
