# v0.4.14.0 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.4.14.0 status | Avalonia/headless state |
|---|---|---|
...
v0.4.14.0 restores World Inspector read-only parity. The headless explorer owns canonical discovery, backup exclusion, file statistics, integrity findings, and the full World ID. The Avalonia client composes player/guild/base evidence on demand without a new timer or direct server filesystem access.

## v0.4.14.0 Configuration parity status
