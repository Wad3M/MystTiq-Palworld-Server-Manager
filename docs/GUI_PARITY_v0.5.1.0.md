# v0.5.1.0 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.5.1.0 status | Avalonia/headless state |
|---|---|---|
...
# v0.5.1.0 integration note

This matrix carries the complete v0.4.18.2 functional closeout forward. v0.5.1.0 changes the shell organization and presentation without replacing its Avalonia/headless implementation: compact supplied MystTiq branding, exact World and System navigation, header notification/settings routing, and glass-highlight hover. All operational parity classifications and their backend evidence remain authoritative.
