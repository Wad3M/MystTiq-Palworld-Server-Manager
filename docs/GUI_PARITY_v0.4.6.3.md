# v0.4.6.3 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.4.6.3 status | Avalonia/headless state |
|---|---|---|
...
## v0.4.6.3 prerequisite note

Page parity is not considered runtime-valid unless the desktop has a compatible management session. v0.4.6.3 therefore makes connection/session establishment and Start Server acceptance a prerequisite before additional legacy page areas can be promoted as migrated.
