# v0.4.15.0 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.4.15.0 status | Avalonia/headless state |
|---|---|---|
...
v0.4.15.0 restores the World Validator, archive import, Player Recovery and Transaction Center safety workflow. The desktop only selects/streams a local ZIP and renders server evidence. The headless service owns validation, bounded archive inspection, expiring single-use plans, fresh backups, staging, atomic promotion, rollback, durable journals and audit. Guild/base binary mutation remains capability-truthful until a safe codec exists.

## v0.4.15.0 Configuration parity status
