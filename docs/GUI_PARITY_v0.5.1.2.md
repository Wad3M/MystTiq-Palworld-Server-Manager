# v0.5.1.2 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.5.1.2 status | Avalonia/headless state |
|---|---|---|
...
# v0.5.1.2 integration note

This matrix carries the complete v0.4.18.2 functional closeout and v0.5.1.0 shell integration forward. v0.5.1.2 places Dashboard and Notifications under Home, keeps Settings and Activity & Audit under System, and applies the approved compact blue glass selection treatment. All operational parity classifications and backend evidence remain authoritative.
