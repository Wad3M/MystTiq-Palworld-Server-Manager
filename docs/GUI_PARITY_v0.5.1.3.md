# v0.5.1.3 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.5.1.3 status | Avalonia/headless state |
|---|---|---|
...
# v0.5.1.3 integration note

This matrix carries the complete v0.4.18.2 functional closeout and corrected v0.5 shell integration forward. v0.5.1.3 keeps Dashboard under Home; places Settings, Notifications and Activity & Audit under System; restores the real add-server tab flow; separates UE4SS runtime/version/fork information from Installed MODs; and standardizes single-line input sizing against the v0.2.16.4 reference. The detailed ordered audit is `GUI_SCREEN_COMPARISON_v0.5.1.3.md`.
