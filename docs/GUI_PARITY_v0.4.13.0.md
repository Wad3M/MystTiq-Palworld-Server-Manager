# v0.4.13.0 GUI parity audit — legacy v0.2.16.4 vs Avalonia
...
| Legacy area | v0.4.13.0 status | Avalonia/headless state |
|---|---|---|
...
v0.4.13.0 expands remote-safe MOD and UE4SS management with validated ZIP upload/install, selected deletion, bulk state changes, authoritative state repair, and audited backend mutation. Disabled and Active / Unverified remain neutral. Workshop, legacy migration, and runtime-wide UE4SS operations remain explicit capability gaps.

## v0.4.13.0 Configuration parity status
