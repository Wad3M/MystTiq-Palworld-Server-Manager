...
public partial class MainWindow : Window
{
    ...
    private readonly ModHealthEvaluationService modHealthEvaluation;
    private readonly ModVerificationService modVerification;
    private readonly ModDashboardStateService modDashboardState;
    private readonly ModPlatformHealthService modPlatformHealth;
    private readonly ModCoordinator modCoordinator;
    private readonly ModRepairRecommendationEngine modRepairRecommendations;
    private readonly ModLifecycleCoordinator modLifecycle;
    private readonly ModVerificationReportExportService modVerificationReportExporter;
    ...
    public MainWindow()
    {
        ...
        var coreServices = ApplicationServiceComposition.Create(settings);
        ue4ssRuntimeResolver = coreServices.Ue4ssRuntimeResolver;
        runtimeState = coreServices.RuntimeState;
        server = coreServices.Server;
        backups = coreServices.Backups;
        config = coreServices.Config;
        mods = coreServices.Mods;
        modHealthEvaluation = coreServices.ModHealthEvaluation;
        modVerification = coreServices.ModVerification;
        modDashboardState = coreServices.ModDashboardState;
        modPlatformHealth = coreServices.ModPlatformHealth;
        modRepairRecommendations = coreServices.ModRepairRecommendations;
        modLifecycle = coreServices.ModLifecycle;
        modVerificationReportExporter = coreServices.ModVerificationReportExporter;
        modCompatibility = coreServices.ModCompatibility;
        environment = coreServices.Environment;
        modInventory = coreServices.ModInventory;
        modCoordinator = coreServices.ModCoordinator;
        installer = coreServices.Installer;
    ...
    private async Task RefreshStatusAsync(bool includeRest = true)
    {
        ...
        DashboardHealthMods.Text = modPlatformHealth.Evaluate(modDashboardRows).HealthLine;
