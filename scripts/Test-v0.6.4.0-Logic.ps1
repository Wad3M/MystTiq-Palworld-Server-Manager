...
# ===========================================================================
# MILESTONE: Player Registry, Activity Intelligence & World Explorer 2
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.4.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Player Registry, Activity Intelligence & World Explorer 2, then create: $implementationMarker"
