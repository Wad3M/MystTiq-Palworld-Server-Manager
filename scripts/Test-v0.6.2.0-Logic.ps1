...
# ===========================================================================
# MILESTONE: Provider Framework & Configuration Intelligence
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.2.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Provider Framework & Configuration Intelligence, then create: $implementationMarker"
