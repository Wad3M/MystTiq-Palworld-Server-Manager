...
# ===========================================================================
# MILESTONE: Safe World Editing, Administration & Player Recovery
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.5.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Safe World Editing, Administration & Player Recovery, then create: $implementationMarker"
