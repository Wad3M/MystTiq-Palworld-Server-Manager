...
$temp=Join-Path $root ("artifacts\runtime-smoke\v0.4.6.7-" + [guid]::NewGuid().ToString('N'))
...
try{
    ...
    Write-Host '[PASS] Runtime Smoke :: Server Setup environment checklist endpoint returns real prerequisite rows' -ForegroundColor Green
