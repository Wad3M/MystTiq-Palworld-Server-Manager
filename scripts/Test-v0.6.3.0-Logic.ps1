...
# ===========================================================================
# MILESTONE: Automation, Notifications & Secure Remote Control
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.3.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Automation, Notifications & Secure Remote Control, then create: $implementationMarker"
