...
# ===========================================================================
# MILESTONE: Transactional Updates, Discovery, Setup & Migration
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.7.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Transactional Updates, Discovery, Setup & Migration, then create: $implementationMarker"
