...
Check 'Versioning' 'Version is v0.4.4.3' ($props -match '<VersionPrefix>0\.4\.4\.3</VersionPrefix>' -and $vm -match 'Version => "v0\.4\.4\.3"')
...
Check 'Documentation' 'README identifies v0.4.4.3 candidate and v0.4.3.1 baseline' ($readme -match 'v0\.4\.4\.3' -and $readme -match 'v0\.4\.3\.1')
Check 'Documentation' 'Roadmap identifies v0.4.4.3 current candidate' ($road -match 'v0\.4\.4\.3')
...
Check 'Testing UX' 'README includes full clean/unblock/validate/current-logic command sequence' ($readme -match 'Get-ChildItem \. -Recurse -Filter \*\.ps1 \| Unblock-File' -and $readme -match 'Test-v0\.4\.4\.3-Logic\.ps1')
