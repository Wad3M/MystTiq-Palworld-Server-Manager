...
# ===========================================================================
# MILESTONE: Advanced Intelligence, Remote Clients, Simulation & UX Completion
#
# IMPORTANT:
...
$implementationMarker = Join-Path $root 'scripts\Testing\Implemented\0.6.9.0.logic-ready'
Add-MystTiqCheck $ctx 'Milestone Gate' `
    ...
    -Severity Critical `
    -Details "Implement the behavioral tests for Advanced Intelligence, Remote Clients, Simulation & UX Completion, then create: $implementationMarker"
